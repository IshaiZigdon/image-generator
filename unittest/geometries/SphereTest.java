...
public class SphereTest {
    ...
    public void testFindGeoIntersectionsHelper() {
        ...
        assertNull(sphere.findGeoIntersectionsHelper((new Ray(p01, v110))), "TC01: Ray's line out of sphere");
        // TC02: Ray starts before and crosses the sphere (2 points)
        final var result02 = sphere.findGeoIntersectionsHelper(new Ray(p01, v310)).stream().sorted(Comparator.comparingDouble(p -> p.point.distance(p01))).toList();
        ...
        final var result11 = sphere.findGeoIntersectionsHelper(new Ray(gp1, v310));
        ...
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(gp2, v310)), "TC11: Ray's line out of sphere");
        ...
        final var result15 = sphere.findGeoIntersectionsHelper(new Ray(pHalf, v300));
        ...
        final var result16 = sphere.findGeoIntersectionsHelper(new Ray(p100, v300));
        ...
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(p200, v300)), "TC16: Ray's line out of sphere");
        // TC17: Ray starts after sphere (0 points)
        final Point p2Half = new Point(2.5, 0, 0);
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(p2Half, v300)), "TC17: Ray's line out of sphere");
        // **** Group: Ray's line is tangent to the sphere (all tests 0 points)
        // TC18: Ray starts before the tangent point
        final Point p010 = new Point(0, 1, 0);
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(p010, v300)), "TC18: Ray's line out of sphere");
        // TC19: Ray starts at the tangent point
        final Point p110 = new Point(1, 1, 0);
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(p110, v300)), "TC19: Ray's line out of sphere");
        // TC20: Ray starts after the tangent point
        // p03 = new Point(2, 1, 0);
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(p03, v300)), "TC20: Ray's line out of sphere");
        // **** Group: Special cases
        // TC21: Ray's line is outside, ray is orthogonal to ray start to sphere's center line
        final Point p020 = new Point(0, 2, 0);
        assertNull(sphere.findGeoIntersectionsHelper(new Ray(p020, v300)), "TC21: Ray's line out of sphere");
